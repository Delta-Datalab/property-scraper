...
def test_validateRealStateAgency(fixture_real_state_agency_data, scraper):
    properties = scraper.getProperties(fixture_real_state_agency_data, "www.zonaprop.com.ar")
    properties_real_state_agency_data = scraper.getRealStateAgencyFromProperties(properties)

    expected_real_state_agency = getRealStateAgencyFromFixtureData()

    pd.testing.assert_frame_equal(properties_real_state_agency_data, expected_real_state_agency)
